...
def plot_data(dara, indicators, sync_axis=None):
    pass
...
date_picker_from = DatePicker(title="start date", value="2022-01-01", min_date="2020-01-01", max_date=dt.datetime.now().strftime("%Y-%m-%d"))
date_picker_to = DatePicker(title="end date", value="2022-02-01", min_date="2020-01-01", max_date=dt.datetime.now().strftime("%Y-%m-%d"))
indicator_choice = MultiChoice(options=['100 day sma', 'linear regression line'])
